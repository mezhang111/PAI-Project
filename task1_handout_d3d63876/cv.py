...
class Model(object):
    ...
    def __init__(self, c, h):
        ...
        self.kernel = ConstantKernel(c, constant_value_bounds = 'fixed')*RBF(h, length_scale_bounds = 'fixed')
...
def main():
    ...
    parameters = [(a,b) for a in c for b in h]
